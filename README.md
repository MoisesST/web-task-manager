...
## [Link to Prototype](https://www.figma.com/file/JqPHJeUvhcEsRcSj1zOLdh/Task-Manager?type=design&node-id=6%3A455&mode=design&t=8MHlW6snRScgR6uz-1)
...
```
$ ng g c components/elements/svg --skip-tests -s -d
```

```
$ ng g c components/elements/svg --skip-tests -s
```
